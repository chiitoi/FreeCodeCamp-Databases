...
INSERT INTO public.appointments VALUES (363, 299, 1, '1030');
...
INSERT INTO public.customers VALUES (299, 'Fabio', '555-555-5555');
...
INSERT INTO public.services VALUES (6, 'test hair cut');
...
SELECT pg_catalog.setval('public.appointments_appointment_id_seq', 369, true);
...
SELECT pg_catalog.setval('public.customers_customer_id_seq', 304, true);
